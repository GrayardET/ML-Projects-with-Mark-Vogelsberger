...
class CNN_drop_norm_reg_small(nn.Module):
    def __init__(self):
        super(CNN_drop_norm_reg_small, self).__init__()
        ...
        self.norm2 = nn.BatchNorm2d(8, affine=True)
...
def train_cnn(batch_size, epoche, learning_rate, train_folds, val_index, best_validation_accuracy):
    title = "REG_DROP_NORM_STRIDE_SMALL|batch_szie:%d|Epoche:%d|Learning_rate:%f|K:%d" % (batch_size, epoche, learning_rate, K)
